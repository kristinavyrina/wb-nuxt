      ...
      <table class="cart-table">
        ...
        <tbody class="cart-table__goods">
          <tr class="cart-item" v-for="item in cart" :key="item.id">
            ...
            <td>{{ item.price }}$</td>
            <td>
              <button class="cart-btn-minus" :disabled="item.count <= 1" @click="decrease(item)">
                -
              </button>
            </td>
            <td>{{ item.count }}</td>
            ...
            <td>
              <button class="cart-btn-delete" @click="remove(item)">
                x
              </button>
            </td>
          </tr>
...
import {useCart} from "~/composables/states.js";
